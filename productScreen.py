...
def products(main, vendingState):
    ...
    Hide_And_Sick_img.place(x=485,y=145)
    ...
    Hide_And_Sick_btn.place(x=485,y=145)
    ...
    hide_and_sick.place(x=480,y=235)
